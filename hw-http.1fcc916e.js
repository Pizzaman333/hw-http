...
var _countriesLayout = require("./js/countries-layout");

},{"./js/fetch-countries":"cc8m7","./js/countries-layout":"kz2Nj"}],"cc8m7":[function(require,module,exports,__globalThis) {
...
},{}],"kz2Nj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _fetchCountries = require("./fetch-countries");
var _fetchCountriesDefault = parcelHelpers.interopDefault(_fetchCountries);
var _lodash = require("lodash");
(0, _fetchCountriesDefault.default)("france").then((country)=>console.log(country));
const searchInput = document.getElementById("search");
const errorBox = document.querySelector(".error__box");
const results = document.querySelector(".results");
const debouncedSearch = (0, _lodash.debounce)((event)=>{
    (0, _fetchCountriesDefault.default)(event.target.value).then((countries)=>{
        results.innerHTML = "";
        ...
        if (countries.length > 10) {
            ...
            countries.forEach((country)=>results.innerHTML += `<li class="country">
        ...
        countries.forEach((country)=>{
          ...
          <img src="${country.flags.png}" alt="flag" class="country__flag">
            ...
            for(const key in country.languages)document.querySelector(".country__languages").innerHTML += `<li class="country__language">${country.languages[key]}</li>`;
        });
    });
}, 300);
searchInput.addEventListener("input", debouncedSearch);

},{"./fetch-countries":"cc8m7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","lodash":"LUhzz"}],"LUhzz":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequire3f21", {})

//# sourceMappingURL=hw-http.1fcc916e.js.map
